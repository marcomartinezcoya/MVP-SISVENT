...
export const Modal: React.FC<ModalProps> = ({ 
  ...
  return (
    <div style={{ zIndex: 10000 }} className="fixed inset-0 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm transition-opacity">
      <div 
      ...
      />
      <div
        className={`relative w-full ${maxWidth} bg-surface-container border border-outline-variant/10 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col`}
